...
def callback(data):
    ...
    if not body:
	    ...
	    if len(bodies)!=0:
            ...
            h, w = img.shape[:2]
            #resize frame
            #frame_re = cv2.resize(img, (320, 240))
...
body_detector = cv2.CascadeClassifier('/home/osman/catkin_ws/src/FaceReco/faceReco/scripts/haarcascade_upperbody.xml')
...
vel_pub = rospy.Publisher('/vgg16/velocity',Twist,queue_size=10)
vel_msg = Twist()
